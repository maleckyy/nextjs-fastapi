...
export default function CreateTodoDialog({refetch}: PropsType) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger className='scale-hover'><CirclePlus size={24} className='mt-2'/></DialogTrigger>
                <DialogContent>
                <DialogHeader>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className='flex justify-end'>
                            <Button className='scale-hover' onClick={handleSubmit(handleCreateTodo)} disabled={isSubmitting}>Dodaj zadanie</Button>
                        </div>
                    </div>
                </DialogHeader>
            </DialogContent>
