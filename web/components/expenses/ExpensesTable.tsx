        ...
        <TableBody>
          {data && data.map((item) => (
            <TableRow key={item.id}>
              ...
              <TableCell><Badge variant="default" className={clsx('font-bold text-white', item.expense_type !== 0 ? "bg-green-600" : "bg-red-600")}>{getExpenseType(item.expense_type)}</Badge></TableCell>
